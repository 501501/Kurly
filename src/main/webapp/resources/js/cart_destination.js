...
function openWin(){
	...
	window.open("../../mypage/destination/form", "_blank", 'status=no, height=' + popupHeight  + ', width=' + popupWidth  + ', left='+ popupX + ', top='+ popupY);
}
...
$(".modify").click(function(){
	let post = (this).getAttribute('data-delivery-post');
	window.open("../../mypage/destination/modify?post="+post, "_blank", "width=800, height=700");
});
