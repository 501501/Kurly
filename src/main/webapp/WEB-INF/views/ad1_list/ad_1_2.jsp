            ...
            <div class="section_view">
                ...
                <div id="sectionView">
                    <div class="inner_view">
                        <div class="thumb">
                            <img src="../../resources/img/ad_1/2.jpg" alt="">
                        </div>
                        ...
                        <p class="goods_name">
                            ...
                            <strong class="name">친환경 아욱&근대 2종</strong>
                            <span class="short_desc">햇빛 담은 Green Table 아욱, 근대 (200g)</span>
                        </p>
                        <p class="goods_price">
                            <span class="position">
                                    ...
                                    <ul class="list list_nopackage">
                                        <li class="on">
                                            ...
                                            <div class="option">
                                                ...
                                                <span class="price">
                                                    <span class="dc_price">2,290원</span>
                                                </span>
                                            </div>
                                        </li>
                                    </ul>
