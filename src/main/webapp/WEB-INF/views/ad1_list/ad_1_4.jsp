                ...
                <div class="section_view">
                    ...
                    <div id="sectionView">
                        <div class="inner_view">
                            <div class="thumb">
                                <img src="../../resources/img/ad_1/4.jpg" alt="">
                            </div>
                            ...
                            <p class="goods_name">
                                ...
                                <strong class="name">[라메종드아모린] 살레위드 솔티드 버터 캐러멜 2종</strong>
                                <span class="short_desc">게랑드 소금과 브루타뉴 솔티드 버터의 환상 조합!</span>
                            </p>
                            <p class="goods_price">
                                <span class="position">
                            ...
                            <div class="goods_info">
                                ...
                                <dl class="list">
                                    ...
                                    <dd class="desc">
                                        <span class="txt">해당 제품은 최저가로 세팅되었으나, 유통사(수입사)의 가격정책이슈로 정상 판매가로 재세팅하였습니다.
                                        </span>
                                        <span class="txt">(단, 이전가격보다 저렴한 가격으로 판매예정/12월말까지)</span>
                                    </dd>
                                </dl>
                            </div>
                        </div>
                    ...
                    <div id="cartPut">
                                        ...
                                        <ul class="list list_nopackage">
                                            <li class="on">
                                                ...
                                                <div class="option">
                                                    ...
                                                    <span class="price">
                                                        <span class="dc_price">7,990원</span>
                                                    </span>
                                                </div>
                                            </li>
                                        </ul>
                        ...
                        <div class="cart_option cart_type3 notify_option">
                            <div class="inner_option">
                                ...
                                <p class="name_deal">친환경 채 도라지 150g</p>
                                <p class="notice">
                                    <span class="ico">·</span>
                        ...
                        <form name="frmBuyNow" method="post" action="/shop/order/order.php"><input type="hidden"
                                name="mode" value="addItem"> <input type="hidden" name="goodsno" value=""></form>
