            ...
            <div class="section_view">
                ...
                <div id="sectionView">
                    <div class="inner_view">
                        <div class="thumb">
                            <img src="../../resources/img/ad_2/1.jpg" alt="">
                        </div>
                        ...
                        <p class="goods_name">
                            ...
                            <strong class="name">[소중한식사] 꼬마김밥 키트</strong>
                        ...
                        <div class="goods_info">
                            ...
                            <dl class="list">
                                ...
                                <dd class="desc"> 
                                    ...
                                    - 본 제품은 난류(가금류에 한함), 우유, 메밀, 땅콩, 대두, 밀, 고등어, 게, 새우, 돼지고기, 복숭아, 잣, 호두, 조개, 닭고기, 쇠고기, 토마토, 오징어, 굴, 전복, 홍합, 참깨를 사용하거나 앞의 재료를 사용한 제품과 같은 제조시설에서 제조하고 있습니다.
                                </dd>
                            </dl>
                            <dl class="list">
                                    ...
                                    <ul class="list list_nopackage">
                                        <li class="on">
                                            ...
                                            <div class="option">
                                                ...
                                                <span class="price">
                                                    <span class="dc_price">6,300원</span>
                                                </span>
                                            </div>
                                        </li>
                                    </ul>
