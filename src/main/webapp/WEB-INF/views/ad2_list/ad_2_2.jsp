            ...
            <div class="section_view">
                ...
                <div id="sectionView">
                    <div class="inner_view">
                        <div class="thumb">
                            <img src="../../resources/img/ad_2/2.jpg" alt="">
                        </div>
                        ...
                        <p class="goods_name">
                            ...
                            <strong class="name">[해밀 : 바다가 주는 식사] 청어알 들기름 카펠리니 파스타 2인 세트 352g(냉장)</strong>
                            <span class="short_desc">간편하게 만드는 한 입 별미 김밥</span>
                        </p>
                        <p class="goods_price">
                            <span class="position">
                        ...
                        <div class="goods_info">
                            ...
                            <dl class="list">
                                ...
                                - 이 제품은 난류, 메밀, 우유, 땅콩, 고등어, 게, 돼지고기, 복숭아, 아황산류, 호두, 닭고기, 오징어, 잣, 조개류(굴, 전복, 홍합 포함)를 사용한 제품과 같은 제조시설에서 제조하고 있습니다.
                                </dd>
                            </dl>
                            <dl class="list">
                                <dt class="tit">유통기한</dt>
                                <dd class="desc">
                                    수령일 포함 2일 남은 제품을 보내 드립니다.
                                </dd>
                            </dl>
                            <dl class="list">
                                ...
                                <dd class="desc">
                                    ...
                                    <span class="txt">수급 상황에 따라 인증 종류 및 번호가 다를 수 있으며, 제품에 표기된 인증번호로 확인 가능합니다.</span>
                                </dd>
                            </dl>
                        </div>
                    </div>
                                    ...
                                    <ul class="list list_nopackage">
                                        <li class="on">
                                            ...
                                            <div class="option">
                                                ...
                                                <span class="price">
                                                    <span class="dc_price">15,931원</span>
                                                </span>
                                            </div>
                                        </li>
                                    </ul>
