            ...
            <div class="section_view">
                ...
                <div id="sectionView">
                    <div class="inner_view">
                        <div class="thumb">
                            <img src="../../resources/img/ad_2/3.jpg" alt="">
                        </div>
                        ...
                        <p class="goods_name">
                            ...
                            <strong class="name">[풀무원다논] 그릭 플레인 (95g*4개입)</strong>
                            <span class="short_desc">매일의 그릭 요거트</span>
                        </p>
                        <p class="goods_price">
                            <span class="position">
                        ...
                        <div class="goods_info">
                            <dl class="list fst">
                                ...
                                <dd class="desc">4개입 </dd>
                            </dl>
                            <dl class="list">
                                <dt class="tit">중량/용량</dt>
                                <dd class="desc">95g</dd>
                            </dl>
                            <dl class="list">
                            ...
                            <dl class="list">
                                ...
                                <dd class="desc"> 냉동  /종이포장 <strong class="emph"> 택배배송은 에코포장이 스티로폼으로 대체됩니다. </strong></dd>
                            </dl>
                            <dl class="list">
                                    ...
                                    <ul class="list list_nopackage">
                                        <li class="on">
                                            ...
                                            <div class="option">
                                                ...
                                                <span class="dc_price">3,621원</span>
                                            </span>
                                            <span class="price">
                                            </div>
                                        </li>
