...
<head>
    ...
    <link rel="stylesheet" href="../resources/css/category/event.css">
...
<body oncontextmenu='return false' onselectstart='return false' ondragstart='return false'>
    ...
    <section>
        <article>
            <div class="image margin_wrap">
                <ul>
                    <li><a href="#"><img src="../resources/img/event/1.webp" alt=""></a></li>
                    <li><a href="#"><img src="../resources/img/event/2.webp" alt=""></a></li>
                    <li><a href="#"><img src="../resources/img/event/3.webp" alt=""></a></li>
                    <li><a href="#"><img src="../resources/img/event/4.webp" alt=""></a></li>
                    <li><a href="#"><img src="../resources/img/event/5.webp" alt=""></a></li>
                </ul>
            </div>
        </article>
    </section>
