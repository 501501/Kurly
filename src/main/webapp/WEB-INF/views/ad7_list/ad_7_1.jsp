            ...
            <div class="section_view">
                ...
                <div id="sectionView">
                    <div class="inner_view">
                        <div class="thumb">
                            <img src="../../resources/img/ad_7/1.jpg" alt="">
                        </div>
                        ...
                        <p class="goods_name">
                            ...
                            <strong class="name">[아이닉] 대용량 에어프라이어 16L (7종 조리도구 포함)</strong>
                        </p>
                        <p class="goods_price">
                            <span class="position">
                ...
                <div id="cartPut">
                                    ...
                                    <ul class="list list_nopackage">
                                        <li class="on">
                                            ...
                                            <div class="option">
                                                ...
                                                <span class="price">
                                                    <span class="dc_price">178,000원</span>
                                                </span>
                                            </div>
                                        </li>
                                    </ul>
                    ...
                    <div class="cart_option cart_type3 notify_option">
                        <div class="inner_option">
                            ...
                            <p class="name_deal">[아이닉] 대용량 에어프라이어 16L (7종 조리도구 포함)</p>
                            <p class="notice">
                                <span class="ico">·</span>
