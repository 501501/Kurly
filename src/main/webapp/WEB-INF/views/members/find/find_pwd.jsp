...
<head>
    ...
    <link rel="stylesheet" href="../resources/css/member/pw.css">
        ...
        <div id="content">
            <div class="section_login">
                ...
                <div class="write_form find_view">
                    <form method="post" id="form" name="fm" action="find_pwd" onsubmit="return chkForm( this );">
                        <input type="hidden" name="act" value="Y">
                        <input type="hidden" name="rncheck" value="none">
                        <input type="hidden" name="dupeinfo" value="">
                        <strong class="tit_label">이름</strong>
                        <input name="name" type="text" size="29" required="" label="이름" tabindex="2">
                        <strong class="tit_label">아이디</strong>
                        <input name="id" value="" type="text" size="29" required="" label="아이디" tabindex="2">
                        <p></p>
                        <strong class="tit_label">이메일</strong>
                        <input name="email" type="text" size="29" required="" label="메일주소" tabindex="5">
                        <p></p>
