            ...
            <div class="section_view">
                ...
                <div id="sectionView">
                    <div class="inner_view">
                        <div class="thumb">
                            <img src="../../resources/img/ad_9/2.jpg" alt="">
                        </div>
                        ...
                        <p class="goods_name">
                            ...
                            <strong class="name">[한트바커] 그릴드 냉장 닭가슴살 2종</strong>
                        </p>
                        <p class="goods_price">
                            <span class="position">
                ...
                <div id="cartPut">
                                    ...
                                    <ul class="list list_nopackage">
                                        <li class="on">
                                            ...
                                            <div class="option">
                                                ...
                                                <span class="price">
                                                    <span class="dc_price">4,290원</span>
                                                </span>
                                            </div>
                                        </li>
                                    </ul>
                    ...
                    <div class="cart_option cart_type3 notify_option">
                        <div class="inner_option">
                            ...
                            <p class="name_deal">[한트바커] 그릴드 냉장 닭가슴살 2종</p>
                            <p class="notice">
                                <span class="ico">·</span>
