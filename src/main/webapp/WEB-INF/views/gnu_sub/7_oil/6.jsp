    ...
    <section>
        ...
        <article class="con margin_wrap">
            ...
            <div class="goods">
                <ul class="goods_list">
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/7/6/1.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>메이플 스프레드 160g</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>12,900원</span>
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/7/6/2.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>비건 달걀 대용 파우더</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>3,480원</span>
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/7/6/3.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>[백설]머핀 믹스</span>
                        </div>
                        <div class="pro_cou">
