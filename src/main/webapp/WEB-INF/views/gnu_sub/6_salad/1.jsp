    ...
    <section>
        ...
        <article class="con margin_wrap">
            ...
            <div class="goods">
                <ul class="goods_list">
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/6/1/1.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>베지 떡갈비</span>
                        </div>
                        <div class="pro_cou">
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/6/1/2.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>닭가슴살 큐브 6종(5개 묶음)</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>6,100원</span>
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/6/1/3.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>버거 패티 230g</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>11,000원</span>
