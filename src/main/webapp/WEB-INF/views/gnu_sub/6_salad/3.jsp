    ...
    <section>
        ...
        <article class="con margin_wrap">
            ...
            <div class="goods">
                <ul class="goods_list">
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/6/3/1.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>통밀국수 400g</span>
                        </div>
                        <div class="pro_cou">
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/6/3/2.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>유면가X주옥 약고추장 깻잎면</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>12,150원</span>
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/6/3/3.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>족빔면 (족발&비빔국수)</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>9,800원</span>
