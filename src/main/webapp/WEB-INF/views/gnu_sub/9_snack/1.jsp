    ...
    <section>
        ...
        <article class="con margin_wrap">
            ...
            <div class="goods">
                <ul class="goods_list">
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/9/1/1.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>아티장비스킷 치즈를 위한 토스트</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>10,900원</span>
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/9/1/2.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>[비첸지]미니 스낵 밀크 1박스</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>12,130원</span>
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/9/1/3.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>아티장비스킷 치즈를 위한 토스트</span>
                        </div>
                        <div class="pro_cou">
