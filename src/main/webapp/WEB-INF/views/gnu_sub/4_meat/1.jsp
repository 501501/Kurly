    ...
    <section>
        ...
        <article class="con margin_wrap">
            ...
            <div class="goods">
                <ul class="goods_list">
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/4/1/1.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>한우 실속 정육 세트 1호</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>39,900원</span>
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/4/1/2.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>한우 실속 모둠 세트 1호 1kg</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>48,100원</span>
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/4/1/3.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>1+ 한우 안심 구이용 200g</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>11,000원</span>
