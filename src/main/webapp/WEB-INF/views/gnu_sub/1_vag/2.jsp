    ...
    <section>
        ...
        <article class="con margin_wrap">
            ...
            <div class="goods">
                <ul class="goods_list">
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/1/2/1.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>유기농 다진 당근 60g (냉동)</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>2,200원</span>
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/1/2/2.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>텃밭 채소 씨앗 10종</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>1,000원</span>
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/1/2/3.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>새싹 채소 씨앗 10종</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>1,500원</span>
