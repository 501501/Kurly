    ...
    <section>
        ...
        <article class="con margin_wrap">
            ...
            <div class="goods">
                <ul class="goods_list">
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/1/4/1.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>베이비 브로콜리 200g</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>3,390원</span>
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/1/4/2.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>유기농 다진 적양배추 60g (냉동)</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>3,500원</span>
                    ...
                    <li>
                        <a href="#"><img src="../../resources/img/gnb_list/1/4/3.jpg" alt=""></a>
                        <div class="pro_tit">
                            <span>유기농 사포나리아 알로에 4입</span>
                        </div>
                        <div class="pro_cou">
                            <span></span>
                            <span>9,800원</span>
