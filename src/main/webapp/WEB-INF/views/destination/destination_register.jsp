...
<body>
	...
	<form id="frm" method="post" action="./form">
		...
		<div>
			<input type="text" id="isDefault" name="default_type" value="n" hidden="hidden">
		...
		<div>
			...
			<input type="text" name="shipping_type" id="shipping_type" hidden="hidden">
			<input type="text" value="y" name="check_type" id="check_type" hidden="hidden">
		</div>
