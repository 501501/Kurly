            ...
            <div class="section_view">
                ...
                <div id="sectionView">
                    <div class="inner_view">
                        <div class="thumb">
                            <img src="../../resources/img/ad_5/3.jpg" alt="">
                        </div>
                        ...
                        <p class="goods_name">
                            ...
                            <strong class="name">[타미나] 부드러운 황도 복숭아 1.8kg 5~6입</strong>
                        </p>
                        <p class="goods_price">
                            <span class="position">
                        ...
                        <div class="goods_info">
                            ...
                            <dl class="list">
                                ...
                                <dd class="desc"> 2021년 10월 21일 23시 주문건까지, 유통기한 2021년 12월 8일 상품출고</dd>
                            </dl>
                            <dl class="list">
                ...
                <div id="cartPut">
                                    ...
                                    <ul class="list list_nopackage">
                                        <li class="on">
                                            ...
                                            <div class="option">
                                                ...
                                                <span class="price">
                                                    <span class="dc_price">21,090원</span>
                                                </span>
                                            </div>
                                        </li>
                                    </ul>
                    ...
                    <div class="cart_option cart_type3 notify_option">
                        <div class="inner_option">
                            ...
                            <p class="name_deal">[타미나] 부드러운 황도 복숭아 1.8kg 5~6입</p>
                            <p class="notice">
                                <span class="ico">·</span>
