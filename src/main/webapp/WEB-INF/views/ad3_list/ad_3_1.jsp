            ...
            <div class="section_view">
                ...
                <div id="sectionView">
                    <div class="inner_view">
                        <div class="thumb">
                            <img src="../../resources/img/ad_3/1.jpg" alt="">
                        </div>
                        ...
                        <p class="goods_name">
                            ...
                            <strong class="name">[3분포차] 직화닭목살구이</strong>
                            <span class="short_desc">쫄깃한 닭 목살을 매콤하게!</span>
                        </p>
                        <p class="goods_price">
                            <span class="position">
                                    ...
                                    <ul class="list list_nopackage">
                                        <li class="on">
                                            ...
                                            <div class="option">
                                                ...
                                                <span class="price">
                                                    <span class="dc_price">4,725원</span>
                                                </span>
                                            </div>
                                        </li>
                                    </ul>
