            ...
            <div class="section_view">
                ...
                <div id="sectionView">
                    <div class="inner_view">
                        <div class="thumb">
                            <img src="../../resources/img/ad_3/2.jpg" alt="">
                        </div>
                        ...
                        <p class="goods_name">
                            ...
                            <strong class="name">[미소향] 국내산 소고기 견과육포 80g</strong>
                            <span class="short_desc">견과류가 콕콕 박힌 이색 육포</span>
                        </p>
                        <p class="goods_price">
                            <span class="position">
                        ...
                        <div class="goods_info">
                            ...
                            <dl class="list">
                                ...
                                <dd class="desc">
                                    - 소고기, 돼지고기, 밀, 우유, 대두, 호두 함유
                                </br>
                                    - 닭고기, 토마토, 조개류와 같은 시설에서 제조
                                </dd>
                            </dl>
                        </div>
                    </div>
